...
public class ManageEmployeePanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        UserTypeComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Journalist", "Editor" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(passwordJTextField, javax.swing.GroupLayout.DEFAULT_SIZE, 195, Short.MAX_VALUE)
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        if(!organization.getUserAccountDirectory().getAccountList().isEmpty()){
            JOptionPane.showMessageDialog(null, "Only one employee of this type can be created!");
            return;
        }
